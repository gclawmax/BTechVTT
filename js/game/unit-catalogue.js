...
const BT_WEAPONS = {
  ...
  uac2:       { name: 'Ultra AC/2', damage: 2, heat: 1, range: [8, 17, 25], minimumRange: 3, ammoType: 'uac2' },
  uac5:       { name: 'Ultra AC/5', damage: 5, heat: 1, range: [6, 13, 20], minimumRange: 2, ammoType: 'uac5' },
  uac10:      { name: 'Ultra AC/10', damage: 10, heat: 4, range: [6, 12, 18], ammoType: 'uac10' },
  uac20:      { name: 'Ultra AC/20', damage: 20, heat: 8, range: [3, 7, 10], ammoType: 'uac20' },
  light_gauss:{ name: 'Light Gauss Rifle', damage: 8, heat: 1, range: [8, 17, 25], minimumRange: 3, ammoType: 'light_gauss' },
  heavy_gauss:{ name: 'Heavy Gauss Rifle', damage: 25, damageByRange: [25, 20, 10], heat: 2, range: [6, 13, 20], minimumRange: 4, ammoType: 'heavy_gauss' },
  er_small_laser:{ name: 'ER Small Laser', damage: 3, heat: 2, range: [2, 4, 5] },
  er_med_laser:{ name: 'ER Medium Laser', damage: 5, heat: 5, range: [4, 8, 12] },
  er_large_laser:{ name: 'ER Large Laser', damage: 8, heat: 12, range: [7, 14, 19] },
  er_ppc:     { name: 'ER PPC', damage: 10, heat: 15, range: [7, 14, 23], minimumRange: 3 },
