...
function renderDetail() {
  ...
  body.innerHTML = `
    ...
    <div class="stat-grid">
      ...
      <div class="k">Damage State</div><div class="v">${inst.destroyed ? 'DESTROYED' : `${Object.values(inst.criticalSlotDamage || {}).reduce((total, slots) => total + slots.length, 0)} critical slot${Object.values(inst.criticalSlotDamage || {}).reduce((total, slots) => total + slots.length, 0) === 1 ? '' : 's'} damaged`}</div>
