...
check('guidance and roadmap record Career-3 completion', guide.includes('Regional Operations connects five worlds') && roadmap.includes('Current development priority — Career-4 review') && design.includes('implemented in SQL 142'));
check('the browser exposes the Career-3 build',index.includes('20260908-career3-regions-96'));
