...
const balance=sandbox.flagAIEvaluationBalance({byVictory:{control:{appearances:12,pairedComparisons:12,pairedSeatOneAdvantages:10,pairedSeatTwoAdvantages:0,roundLimitAdjudicationRate:60,noScoreRate:80,roundLimitAdjudications:7,nonScoring:10}},byMap:{'custom:asymmetric':{appearances:12,pairedComparisons:12,pairedSeatOneAdvantages:0,pairedSeatTwoAdvantages:10,roundLimitAdjudicationRate:0,noScoreRate:0,roundLimitAdjudications:0,nonScoring:0}}});
check('GM-5 balance flags identify paired seat bias, round-limit adjudications and ignored objectives',balance.flags.some(flag=>flag.type==='seat_bias')&&balance.flags.some(flag=>flag.type==='round_limit_adjudications')&&balance.flags.some(flag=>flag.type==='objectives_ignored'),JSON.stringify(balance));
const insufficientPairEvidence=sandbox.flagAIEvaluationBalance({byVictory:{control:{appearances:20,pairedComparisons:20,pairedSeatOneAdvantages:4,pairedSeatTwoAdvantages:0,roundLimitAdjudicationRate:0,noScoreRate:0,roundLimitAdjudications:0,nonScoring:0}},byMap:{}});
check('GM-5 does not call seat bias from too few decisive mirrored outcomes',!insufficientPairEvidence.flags.some(flag=>flag.type==='seat_bias'),JSON.stringify(insufficientPairEvidence));
