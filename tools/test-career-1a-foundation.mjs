...
check('the roadmap records Career as an isolated persistent system', roadmap.includes('Career | Done: regional loop') && roadmap.includes('Current development priority — Career-4 review'));
