...
check('the roadmap records Career as an isolated persistent system', roadmap.includes('Career | Done: founding arcs') && roadmap.includes('Current development priority — Career-4b PvP tender design'));
