...
check('the roadmap records Career-1 as a completed isolated foundation', roadmap.includes('Career | Done: first loop') && roadmap.includes('Current development priority — BV-4 and Career-2 planning'));
