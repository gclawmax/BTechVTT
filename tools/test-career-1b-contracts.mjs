...
check('the roadmap records Career-1b as a completed prerequisite', roadmap.includes('Career-1b adds deterministic AI contracts') && roadmap.includes('Current development priority — BV-4 and Career-2 planning'));
