...
- **Implemented in build `20260907-gm5-decisive-pairs-81`.** The
...
- Coverage rotates built-in maps plus repeatable symmetric and asymmetric
  ...
  editor.
- Balance review flags require ten decisive mirrored pairs before calling a
  seat advantage, and call out excessive round-limit adjudications or objective
