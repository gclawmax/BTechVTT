-- The lobby saves after each selected BattleMech is placed. SQL/54 required
-- a complete roster on every save, so any roster of two or more could never
-- place its first unit. Run after SQL/78.
