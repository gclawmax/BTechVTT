...
| 7 — Polish & Deployment | 🟨 In progress | Map/scenario editor complete; sound effects, campaign mode and production deployment beyond GitHub Pages remain |
...
2. Phase 7 polish: sound effects → campaign mode → production
   deployment.
