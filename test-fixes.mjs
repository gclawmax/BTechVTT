...
check('#5 advanced AI weighs MASC risk and uses the authoritative failure resolver', mascAiSource.includes('riskAcceptable') && mascAiSource.includes('mascTarget <= 7') && mascAiSource.includes("{ ...step, masc: true }") && mascAiSource.includes("db.rpc('submit_battlemech_movement'"));
