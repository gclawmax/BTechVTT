...
check('#5 dropship and fixed build stamps share the one visible release marker', indexSource.includes('data-build="20260902-variable-maps-50"') && indexSource.includes('id="map-build-stamp"') && supabaseSource.includes("document.body.dataset.build") && supabaseSource.includes("#bt-build-stamp, #map-build-stamp"));
...
check('#5 variable maps support standard sheets, dual-board presets and seeded terrain', scenarioEditorSource.includes("['single', 16, 17") && scenarioEditorSource.includes("['dual-vertical', 16, 34") && scenarioEditorSource.includes("['dual-horizontal', 32, 17") && scenarioEditorSource.includes('seededRandom') && mapsSource.includes('function mapDimensions') && mapsSource.includes("'standard-dual-horizontal'"));
